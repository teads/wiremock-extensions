...
2. [Download Extension Jar](https://github.com/teads/wiremock-extensions/releases/download/v0.6/wiremock-extensions_2.11-0.6.jar)
3. Run  
```
  java -cp "wiremock-1.58-standalone.jar:wiremock-extensions_2.11-0.6.jar" \
