...
2. [Download Extension Jar](https://github.com/teads/wiremock-extensions/releases/download/v0.14/wiremock-extensions_2.11-0.14.jar)
3. Run  
```
  java -cp "wiremock-standalone-2.8.0.jar:wiremock-extensions_2.11-0.14.jar" \
